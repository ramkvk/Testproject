...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' ../libevent.la ../libevent_pthreads.la ../libevent_openssl.", f);
  fputs ("la /home/Karthik/Testproject/libevent/libevent-2.0.22-stable/libevent_core.la'\n", f);
  fputs ("else\n", f);
