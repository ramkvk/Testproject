...
/* ./.libs/lt-le-proxy.c - temporary wrapper executable for .libs/le-proxy
   Generated by libtool (GNU libtool) 2.4.2

   The le-proxy program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/home/Karthik/Testproject/libevent/libevent-2.0.22-stable/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/Karthik/Testproject/libevent/libevent-2.0.22-stable/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "le-proxy"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# le-proxy - temporary wrapper script for .libs/le-proxy\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The le-proxy program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libevent.la ../libevent_openssl.la /home/Karthik/Testpro", f);
  fputs ("ject/libevent/libevent-2.0.22-stable/libevent_core.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"le-proxy:le-proxy:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"le-proxy:le-proxy:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"le-proxy:le-proxy:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/home/Karthik/Testproject/libevent/libevent-2.0.22-stable/.libs:/usr/l", f);
  fputs ("ocal/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/Karthik/Testproject/libevent/libevent-2.0.22-stable/.libs:$PATH", f);
  fputs ("\"\n", f);
  fputs ("\n", f);
